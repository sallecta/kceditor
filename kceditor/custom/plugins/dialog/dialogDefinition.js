 ...
 *
 *		kceditor.dialog.add( 'testOnly', function( editor ) {
 *			return {
 *				title:			'Test Dialog',
 ...
 *		} );
 *
 * @class kceditor.dialog.definition
 */
 ...
 *
 * * {@link kceditor#DIALOG_RESIZE_NONE}
 * * {@link kceditor#DIALOG_RESIZE_WIDTH}
 * * {@link kceditor#DIALOG_RESIZE_HEIGHT}
 * * {@link kceditor#DIALOG_RESIZE_BOTH}
 *
 * @property {Number} [resizable=kceditor.DIALOG_RESIZE_NONE]
 */
 ...
 *
 * @since 3.5.3
 * @property {Number} [width=kceditor.dialog.definition#minWidth]
 */
 ...
 *
 * @since 3.5.3
 * @property {Number} [height=kceditor.dialog.definition.minHeight]
 */

/**
 * The buttons in the dialog, defined as an array of
 * {@link kceditor.dialog.definition.button} objects.
 *
 * @property {Array} [buttons=[ kceditor.dialog.okButton, kceditor.dialog.cancelButton ]]
 */

/**
 * The contents in the dialog, defined as an array of
 * {@link kceditor.dialog.definition.content} objects. Required.
 *
 ...
 * For widget plugins (`image2`, `placeholder`) it should return a {@link kceditor.plugins.widget} instance that
 * is the subject of this dialog.
 *
 * @since 4.13.0
 * @method getModel
 * @param {kceditor.editor} editor
 * @returns {kceditor.dom.element/kceditor.plugins.widget/Object/null} Returns `null` if the dialog does not use the model.
 */

/**
 * Returns the current dialog mode based on the state of the feature used with this dialog.
 *
 * See {@link kceditor.dialog#EDITING_MODE} and {@link kceditor.dialog#CREATION_MODE}.
 *
 * @since 4.13.0
 * @method getMode
 * @param {kceditor.editor} editor
 ...
 *
 * @class kceditor.dialog.definition.content.
 */
 ...
 * {@link kceditor.dialog.definition.uiElement} objects.
 *
 ...
 *
 * @class kceditor.dialog.definition.uiElement
 * @see kceditor.ui.dialog.uiElement
 */
 ...
 * All formats accepted by {@link kceditor.filter#check} may be used.
 *
 * When all UI elements in a tab are disabled, this tab will be disabled automatically.
 *
 * @property {String/Object/kceditor.style} requiredContent
 */
 ...
 * dialog's {@link kceditor.dialog#setupContent} method is executed.
...
/**
 * Function to execute whenever the UI element's parent
 * dialog's {@link kceditor.dialog#commitContent} method is executed.
 * It usually takes care of the respective UI element as a standalone element.
 *
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.hbox} object and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 *		// There is no constructor for this class, the user just has to define an
 *		// object with the appropriate properties.
 *
 ...
 *		}
 *
 * @class kceditor.dialog.definition.hbox
 * @extends kceditor.dialog.definition.uiElement
 */
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.vbox} object and can
 * be accessed with {@link kceditor.dialog#getContentElement}.
 *
 *		// There is no constructor for this class, the user just has to define an
 *		// object with the appropriate properties.
 *
 ...
 *		}
 *
 * @class kceditor.dialog.definition.vbox
 * @extends kceditor.dialog.definition.uiElement
 */
 ...
 * that developers can use to define and create dialog UI elements.
 *
 * @class kceditor.dialog.definition.labeledElement
 * @extends kceditor.dialog.definition.uiElement
 * @see kceditor.ui.dialog.labeledElement
 */
 ...
 * label and the content element. See also {@link kceditor.dialog.definition.labeledElement#labelLayout}.
 *
 *		{
 *			type: 'text',
 *			label: 'My Label',
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.button} object
 * and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 * For a complete example of dialog definition, please check {@link kceditor.dialog#add}.
 *
 *		// There is no constructor for this class, the user just has to define an
 *		// object with the appropriate properties.
 *
 ...
 *			title: 'My title',
 *			onClick: function() {
 *				// this = kceditor.ui.dialog.button
 *				alert( 'Clicked: ' + this.id );
 *			}
 *		}
 *
 * @class kceditor.dialog.definition.button
 * @extends kceditor.dialog.definition.uiElement
 */
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.checkbox} object
 * and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 * For a complete example of dialog definition, please check {@link kceditor.dialog#add}.
 *
 ...
 *			'default': 'checked',
 *			onClick: function() {
 *				// this = kceditor.ui.dialog.checkbox
 *				alert( 'Checked: ' + this.getValue() );
 *			}
 *		}
 *
 * @class kceditor.dialog.definition.checkbox
 * @extends kceditor.dialog.definition.uiElement
 */
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.file} object
 * and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 * For a complete example of dialog definition, please check {@link kceditor.dialog#add}.
 *
 ...
 *		}
 *
 * @class kceditor.dialog.definition.file
 * @extends kceditor.dialog.definition.labeledElement
 */
 ...
 * If empty, KCEditor will use path to server connector for currently opened folder.
 *
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.fileButton} object
 * and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 * For a complete example of dialog definition, please check {@link kceditor.dialog#add}.
 *
 * @class kceditor.dialog.definition.fileButton
 * @extends kceditor.dialog.definition.uiElement
 */
...
/**
 * The instruction for KCEditor how to deal with file upload.
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.html} object
 * and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 * For a complete example of dialog definition, please check {@link kceditor.dialog#add}.
 * To access HTML elements use {@link kceditor.dom.document#getById}.
 *
 *		// There is no constructor for this class, the user just has to define an
 *		// object with the appropriate properties.
 *
 ...
 *				// document = kceditor.dom.document
 ...
 *				}
 *			],
 *			buttons: [ kceditor.dialog.cancelButton, kceditor.dialog.okButton ]
 *		};
 *
 * @class kceditor.dialog.definition.html
 * @extends kceditor.dialog.definition.uiElement
 */
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.radio} object
 * and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 * For a complete example of dialog definition, please check {@link kceditor.dialog#add}.
 *
 ...
 *			'default': 'DE',
 *			onClick: function() {
 *				// this = kceditor.ui.dialog.radio
 *				alert( 'Current value: ' + this.getValue() );
 *			}
 *		}
 *
 * @class kceditor.dialog.definition.radio
 * @extends kceditor.dialog.definition.labeledElement
 */
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.select} object
 * and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 * For a complete example of dialog definition, please check {@link kceditor.dialog#add}.
 *
 ...
 *				// this = kceditor.ui.dialog.select
 *				alert( 'Current value: ' + this.getValue() );
 *			}
 *		}
 *
 * @class kceditor.dialog.definition.select
 * @extends kceditor.dialog.definition.labeledElement
 */
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.textInput} object
 * and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 * For a complete example of dialog definition, please check {@link kceditor.dialog#add}.
 *
 ...
 *		}
 *
 * @class kceditor.dialog.definition.textInput
 * @extends kceditor.dialog.definition.labeledElement
 */
...
/**
 * @property bidi
 * @inheritdoc kceditor.dialog.definition.textarea#bidi
 */
 ...
 *
 * Once the dialog is opened, the created element becomes a {@link kceditor.ui.dialog.textarea} object
 * and can be accessed with {@link kceditor.dialog#getContentElement}.
 *
 * For a complete example of dialog definition, please check {@link kceditor.dialog#add}.
 *
...
* 		}
 *
 * @class kceditor.dialog.definition.textarea
 * @extends kceditor.dialog.definition.labeledElement
 */
