...
In this file we interact with the KCEditor JavaScript API to register the skin
...
setting kceditor.skin.name. All the rest is optional, but recommended to be
...
// 1. Register the skin
// ----------------------
// The kceditor.skin.name property must be set to the skin name. This is a
...
kceditor.skin.name = 'moono-lisa';

// 2. Register browser specific skin files
// -----------------------------------------
// (https://github.com/sallecta/kceditor/docs/kceditor4/latest/guide/skin_sdk_browser_hacks.html)
//
...
//
// The accepted browser names must match the kceditor.env properties. The most
// common names are: ie, webkit and gecko. Check the documentation for the complete
// list:
// https://github.com/sallecta/kceditor/docs/kceditor4/latest/api/kceditor_env.html
//
...
kceditor.skin.ua_dialog = 'ie,iequirks,ie8';

// 3. Define the "Chameleon" feature
// -----------------------------------
// (https://github.com/sallecta/kceditor/docs/kceditor4/latest/guide/skin_sdk_chameleon.html)
//
// "Chameleon" is a unique feature available in KCEditor. It makes it possible
...
// The kceditor.skin.chameleon function must be defined. It must return the CSS
// "template" to be used to change the color of a specific KCEditor instance
...
kceditor.skin.chameleon = ( function() {
	...
	return function( editor, part ) {
		var uiColor = editor.uiColor,
			...
			templateStyles = {
				// KCEditor instances have a unique ID, which is used as class name into
				// the outer container of the editor UI (e.g. ".cke_1").
				//
				// The Chameleon feature is available for each KCEditor instance,
...
// ----------------------------------------------------------
// (https://github.com/sallecta/kceditor/docs/kceditor4/latest/guide/skin_sdk_icons.html)
//
// Note: As "moono-lisa" is the default KCEditor skin, it provides no custom icons,
...
//
//		var iconsFolder = kceditor.getUrl( kceditor.skin.path() + 'icons/' + ( kceditor.env.hidpi ? 'hidpi/' : '' ) );
//
//		for ( var i = 0; i < icons.length; i++ ) {
//			kceditor.skin.addIcon( icons[ i ], iconsFolder + icons[ i ] + '.png' );
//		}
// })();
