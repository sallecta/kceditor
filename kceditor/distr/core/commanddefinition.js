...
/**
 * @fileOverview Defines the "virtual" {@link kceditor.commandDefinition} class
 ...
 * passed to the {@link kceditor.editor#addCommand} function.
 *
 * @class kceditor.commandDefinition
 * @abstract
 */
 ...
 *
 * @method exec
 * @param {kceditor.editor} editor The editor within which to run the command.
 ...
 * {@link kceditor.editor#event-afterCommandExec} event will be fired by the
 ...
 * 				kceditor.ajax.loadXml( 'data.xml', function() {
 ...
 *		} );
 *
 * See also {@link kceditor.command#editorFocus}.
 *
...
/**
 * Whether the command state should be set to {@link kceditor#TRISTATE_DISABLED} on startup.
 *
 ...
 *
 * **Note:** The function provided must be calling {@link kceditor.command#setState} in all circumstances
 ...
 *		} );
 *
 * See also {@link kceditor.command#modes}.
 *
 * @property {Object} [modes={ wysiwyg:1 }]
 */

/**
 * Whether the command should be enabled in the {@link kceditor.editor#setReadOnly read-only mode}.
 *
 * @since 4.0.0
...
/**
 * A property that should be set when a command has no keystroke assigned by {@link kceditor.editor#setKeystroke}, but
 ...
 * {@link kceditor.editor#getCommandKeystroke}.
 *
 * @since 4.6.0
