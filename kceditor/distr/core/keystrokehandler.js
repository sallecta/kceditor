 ...
 */
kceditor.keystrokeHandler = function( editor ) {
	 ...
	 *
	 * Since KCEditor 4 there is no need to modify this property directly during the runtime.
	 * Use {@link kceditor.editor#setKeystroke} instead.
	 */
	this.keystrokes = {};
...
( function() {
	...
	kceditor.keystrokeHandler.prototype = {
		/**
		 * Attaches this keystroke handle to a DOM object. Keystrokes typed
		 * over this object will be handled by this keystrokeHandler.
		 *
		 * @param {kceditor.dom.domObject} domObject The DOM object to attach to.
		 */
 ...
 * for your plugin or during the runtime, use {@link kceditor.editor#setKeystroke} instead.
 *
 * Since default keystrokes are set by the {@link kceditor.editor#setKeystroke}
 * method, by default `config.keystrokes` is an empty array.
 *
 * See {@link kceditor.editor#setKeystroke} documentation for more details
 * regarding the start up order.
 *
 *		// Change default Ctrl+L keystroke for 'link' command to Ctrl+Shift+L.
 *		config.keystrokes = [
 *			...
 *			[ kceditor.CTRL + kceditor.SHIFT + 76, 'link' ],	// Ctrl+Shift+L
 *			...
 *		];
 *
 ...
 *		config.keystrokes = [
 *			...
 *			[ kceditor.CTRL + 76, null ],						// Ctrl+L
 *			...
 *		];
 *
 * In order to reset all default keystrokes, a {@link kceditor#instanceReady} callback should be
 ...
 *			if ( evt.data.keyCode == kceditor.CTRL + 90 ) {
 *				// Do something...
 *
 ...
 *		} );
 *
 * Usually you will want to use the {@link kceditor.editor#setKeystroke} method or
 * the {@link kceditor.config#keystrokes} option to attach a keystroke to some {@link kceditor.command command}.
 ...
 * It is the sum of the current key code and the {@link kceditor#CTRL}, {@link kceditor#SHIFT}
 * and {@link kceditor#ALT} constants, if those are pressed.
 * @param {kceditor.dom.event} data.domEvent A `keydown` DOM event instance. Available since KCEditor 4.4.1.
