...
( function() {
	 ...
	 */
	kceditor.htmlParser.node = function() {};

	kceditor.htmlParser.node.prototype = {
		/**
		...
		remove: function() {
			var children = this.parent.children,
				index = kceditor.tools.indexOf( children, this ),
		 ...
		 *
		 * @since 4.1.0
		 * @param {kceditor.htmlParser.node} node The node that will replace this one.
		 */
		 ...
		 *
		 * @since 4.1.0
		 * @param {kceditor.htmlParser.node} node The node that will precede this element.
		 */
		insertAfter: function( node ) {
			var children = node.parent.children,
				index = kceditor.tools.indexOf( children, node ),
				next = node.next;
		 ...
		 *
		 * @since 4.1.0
		 * @param {kceditor.htmlParser.node} node The node that will follow this element.
		 */
		 ...
		 * @returns {kceditor.htmlParser.element} The closest ancestor which satisfies given condition or `null`.
		 */
		getAscendant: function( condition ) {
			...
			while ( parent && parent.type == kceditor.NODE_ELEMENT ) {
				if ( checkFn( parent ) )
					return parent;
		 ...
		 *
		 * @since 4.3.0
		 * @param {kceditor.htmlParser.element} wrapper The element which will be this element's new parent.
		 * @returns {kceditor.htmlParser.element} Wrapper.
		 */
		 ...
		 */
		getIndex: function() {
			return kceditor.tools.indexOf( this.parent.children, this );
		},
