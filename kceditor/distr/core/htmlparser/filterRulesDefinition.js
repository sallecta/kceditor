...
/**
 * @fileOverview Defines the "virtual" {@link kceditor.htmlParser.filterRulesDefinition} class
 * that contains the definition of filter rules. This file is for
 * documentation purposes only.
 */

/**
 * Abstract class describing the definition of {@link kceditor.htmlParser.filter} rules.
 *
 ...
 *
 * It can be used with {@link kceditor.htmlParser.filter} and {@link kceditor.htmlParser.filter#addRules}.
 *
 * @class kceditor.htmlParser.filterRulesDefinition
 * @abstract
 */

/**
 * @property {kceditor.htmlParser.nameTransformRule[]} elementNames An array of rules for element names transformation.
...
/**
 * @property {kceditor.htmlParser.nameTransformRule[]} attributeNames An array of rules for attribute names transformation.
