...
( function() {
	...
	kceditor.lang = {
		 ...
		 *
		 *		alert( kceditor.lang.languages.en ); // 1
		 */
		languages: {
		...
		load: function( languageCode, defaultLanguage, callback ) {
			...
			if ( !languageCode || !kceditor.lang.languages[ languageCode ] )
			...
			if ( !this[ languageCode ] )
				kceditor.scriptLoader.load( kceditor.getUrl( 'lang/' + languageCode + '.js' ), loadedCallback, this );
			else
				loadedCallback();
		},
		 ...
		 *
		 *		alert( kceditor.lang.detect( 'en' ) ); // e.g., in a German browser: 'de'
		 *
