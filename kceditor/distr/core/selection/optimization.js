...
( function() {
	 ...
	 * @since 4.13.0
	 * @static
	 * @see kceditor.dom.selection.optimizeInElementEnds
	 * @param {kceditor.editor} editor
	 * @member kceditor.dom.selection
	 */
	kceditor.dom.selection.setupEditorOptimization = function( editor ) {
	 ...
	 * @member kceditor.dom.selection
	 */
	kceditor.dom.selection.prototype.optimizeInElementEnds = function() {
		...
		range.shrink( kceditor.SHRINK_TEXT, false, { skipBogus: !kceditor.env.webkit } );
