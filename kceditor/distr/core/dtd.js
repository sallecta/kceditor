...
/**
 * @fileOverview Defines the {@link kceditor.dtd} object, which holds the DTD
 ...
 *		alert( !!kceditor.dtd[ 'p' ][ 'div' ] ); // false
 *
 *		// Check if <p> can be contained in a <div> element.
 *		alert( !!kceditor.dtd[ 'div' ][ 'p' ] ); // true
 *
 *		// Check if <p> is a block element.
 *		alert( !!kceditor.dtd.$block[ 'p' ] ); // true
 *
 ...
 * kceditor.dtd[ 'signature' ] = {
 * 	p: 1,
 * 	img: 1
 * };
 *
 *  // Define <signature> as a block element.
 * kceditor.dtd.$block[ 'signature' ] = 1;
 *
 * // Allow <signature> element to be empty.
 * kceditor.dtd.$empty[ 'signature' ] = 1;
 * ```
 *
...
kceditor.dtd = ( function() {
	...
	X( dtd, {
		 ...
		 * this property is not intended to be checked directly, use {@link kceditor.dom.elementPath#blockLimit} instead.
		 *
