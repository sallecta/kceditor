...
/**
 * @fileOverview Defines the {@link kceditor.config} object that stores the
 * default configuration settings.
 */

/**
 * Used in conjunction with the {@link kceditor.config#enterMode}
 * and {@link kceditor.config#shiftEnterMode} configuration
 ...
 * instance.
 *
 * Read more about setting KCEditor configuration in the
...
kceditor.config = {
	 ...
	 * file present in the root of the KCEditor installation directory.
	 *
	 * KCEditor will recursively load custom configuration files defined inside
	 ...
	 *		kceditor.replace( 'myfield', { customConfig: '/myconfig.js' } );
	 *
	 *		// Do not load any custom configuration file.
	 *		kceditor.replace( 'myfield', { customConfig: '' } );
	 *
	 * @cfg {String} [="<KCEditor folder>/config.js"]
	 */
	 ...
	 * the language specified in the {@link kceditor.config#defaultLanguage}
	...
	/**
	 * The language to be used if the {@link kceditor.config#language}
	 ...
	 *
	 * * {@link kceditor#ENTER_P} (1) &ndash; New `<p>` paragraphs are created.
	 * * {@link kceditor#ENTER_BR} (2) &ndash; Lines are broken with `<br>` elements.
	 * * {@link kceditor#ENTER_DIV} (3) &ndash; New `<div>` blocks are created.
	 *
	 * **Note**: It is recommended to use the {@link kceditor#ENTER_P} setting because of
	 ...
	 *
	 *		// Not recommended.
	 *		config.enterMode = kceditor.ENTER_BR;
	 *
	 * @cfg {Number} [=kceditor.ENTER_P]
	 */
	enterMode: kceditor.ENTER_P,

	/**
	 * Forces the use of {@link kceditor.config#enterMode} as line break regardless
	 * of the context. If, for example, {@link kceditor.config#enterMode} is set
	 * to {@link kceditor#ENTER_P}, pressing the <kbd>Enter</kbd> key inside a
	...
	/**
	 * Similarly to the {@link kceditor.config#enterMode} setting, it defines the behavior
	 ...
	 * Example:
	 *
	 *		config.shiftEnterMode = kceditor.ENTER_P;
	 *
	 * @cfg {Number} [=kceditor.ENTER_BR]
	 */
	shiftEnterMode: kceditor.ENTER_BR,
	 ...
	 * as it uses the styles that come directly from the page that KCEditor is
	 ...
	 *
	 * @cfg {String/Array} [contentsCss=kceditor.getUrl( 'contents.css' )]
	 */
	contentsCss: kceditor.getUrl( 'contents.css' ),
	 ...
	 * {@link kceditor.config#extraPlugins} and {@link kceditor.config#removePlugins}.
	 *
	 ...
	 * to add new plugins without having to touch the {@link kceditor.config#plugins} setting.
	 *
	 * **Note:** The most recommended way to
	 * [add KCEditor plugins](https://github.com/sallecta/kceditor/docs/kceditor4/latest/guide/dev_plugins.html) is through
	 * [KCEditor Builder](https://github.com/sallecta/kceditor/cke4/builder). Read more in the
	 ...
	 * to avoid loading some plugins defined in the {@link kceditor.config#plugins}
	 ...
	 *
	 * Unlike the {@link kceditor.config#height} setting, this
	 ...
	 *			kceditor.CTRL + 66, // Ctrl+B
	 *			kceditor.CTRL + 73, // Ctrl+I
	 *			kceditor.CTRL + 85 // Ctrl+U
	 *		];
	 *
...
// PACKAGER_RENAME( kceditor.config )
